   ...
   <div className="min-h-dvh xl:min-h-full flex flex-col justify-center mx-auto max-w-[1100px] overflow-y-auto xl:mt-[6rem] h-dvh xl:h-full">
      <div className="pb-8 overflow-x-hidden sm:pb-16 md:pb-20 lg:w-full lg:pb-28 xl:pb-32">
          ...
          <div className="max-w-full px-4 pt-[20%] md:pt-[10rem] pb-9 sm:text-center lg:text-left lg:pt-[90px] lg:pb-24 lg-tall:text-center">
            <h1 className="text-[36px] sm:text-[42px] font-bold tracking-tight text-gray-900 sm:text-5xl md:text-[62px] lg:text-[42px] lg-tall:text-[7rem]">
            ...
            <p className="mt-4 xl:text-[1.3rem] text-[17px] md:text-[22px] lg:text-[21px] text-gray-500 sm:mt-5 sm:max-w-4xl sm:mx-auto  lg:mx-0 lg-tall:text-4xl">
          ...
          <div className="relative flex flex-col items-center sm:mt-8 group">
            <img
              className=" object-cover mt-[3.5rem] sm:mt-[4.5rem] md:mt-28 lg:mt-26 z-1 h-auto lg:w-[800px] md:max-w-[650px] w-[100vw] sm:max-w-[600px] scale-90  transition duration-500 ease-in-out group-hover:scale-95"
              src={image}
              alt="Orange SUV"
            />
         <figure className="absolute z-0 rounded-full bg-red-500 w-[65vw] h-[65vw] max-w-[380px] md:max-w-[450px] md:max-h-[450px] max-h-[380px] min-w-[100px] min-h-[100px] lg:max-w-[450px] lg:max-h-[450px] scale-90 transition duration-500 ease-in-out group-hover:scale-100" />
          </div>
        </main>
      </div> 
