...
const WelcomePage = () => {
  return (
    <div className="flex items-center justify-center w-full h-screen bg-center bg-no-repeat bg-contain bg-amber-500" style={{ backgroundImage: `url(${image})` }}>
      <div className="container xl:mt-[-40rem]  2xl:mt-[-30rem] pt-20 mx-auto text-center xl:w-[500px] sm:w-[350px] w-[300px]">
        <h1 className="mb-4 text-6xl font-extrabold text-lime-400">Welcome to Our Vehicle Reservation System</h1>
        <p className="mb-8 text-xl font-bold text-white rounded-full bg-amber-400 sm:text-2xl">Join us and explore a wide range of vehicles</p>
